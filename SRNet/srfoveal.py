...
from .modules import BBoxDecoder, MaskDecoder, GazeShift, Foveal, FovealQ
...
class SRFoveal(nn.Module):
    ...
    def forward(self, batch_dict, *args, **argw):
        ...
        q, qpe, pred_masks, pred_bboxes, pred_objs = self.fovealq(
            feats=zs,
            feats_pe=zs_pe
        )
