...
def add_custom_config(cfg, num_gpus=1):
    ...
    cfg.MODEL.MODULES.FOVEAL_VISION.NUM_BLOCKS = 2
    cfg.MODEL.MODULES.PERIPHERAL_SELECTION = CN()
    cfg.MODEL.MODULES.PERIPHERAL_SELECTION.NUM_BLOCKS = 3
    cfg.MODEL.MODULES.GLOBAL_SALIENCE_VIEW = CN()
    cfg.MODEL.MODULES.GLOBAL_SALIENCE_VIEW.NUM_BLOCKS = 2
