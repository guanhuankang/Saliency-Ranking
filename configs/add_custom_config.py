...
def add_custom_config(cfg):
    ...
    cfg.MODEL.IOR_DECODER.NUM_IOR_POINTS = 256
    cfg.MODEL.IOR_DECODER.NUM_QUERIES = 256
    cfg.MODEL.IOR_DECODER.NUM_BLOCKS = 4
    cfg.MODEL.IOR_DECODER.NUM_TOKENS = 256
    cfg.MODEL.IOR_DECODER.NUM_LAYERS = 2
    ...
    cfg.MODEL.IOR_DECODER.APE = CN()
    cfg.MODEL.IOR_DECODER.APE.HEIGHT = 10
    cfg.MODEL.IOR_DECODER.APE.WIDTH = 10
