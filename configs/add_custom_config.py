...
def add_custom_config(cfg, num_gpus=1):
    ...
    cfg.MODEL.SEMI_SUPERVISED.USED_UNLABEL_IMS = 20
    cfg.MODEL.SEMI_SUPERVISED.UNLABEL_STEP = (10000, 20000)
    cfg.MODEL.SEMI_SUPERVISED.UNLABEL_RATIO = (0.25, 0.50)
    cfg.MODEL.SEMI_SUPERVISED.MOMENTUM = 0.995
